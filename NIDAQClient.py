...
class NIDAQVoltage:
    def __init__(self, position, sampling_freq_in=5000, buffer_in_size=50000):
...
class NIDAQThermo:
    def __init__(self, position, thermocouple_type='J', sampling_freq_in=50000, buffer_in_size=50000):
