...
class NIDAQVoltage:
    def __init__(self, position, sampling_freq_in=5000, buffer_in_size=100000):
...
class NIDAQThermo:
    def __init__(self, position, thermocouple_type='J', sampling_freq_in=5000, buffer_in_size=100000):
